    ...
    await templatesCol.insertMany([
      {
        ...
        style: 'modern',
        description: 'Clean left-aligned layout with a cyan accent ring.',
        category: 'Academic',
        tags: ['modern', 'minimal', 'blue'],
      ...
      },
      {
        ...
        style: 'classic',
        description: 'Formal double border in gold and umber for award ceremonies.',
        category: 'Award',
        tags: ['classic', 'formal', 'gold'],
